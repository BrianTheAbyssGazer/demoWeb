    ...
    return (
        <nav className="navbar navbar-expand-md container-fluid bg-secondary bg-opacity-50 p-0 m-0 h5">
            <div className="container-fluid p-0">
                <a className="navbar-brand p-0 m-0 navbar-height" href="/"><img src={logo} className="img-responsive p-0 m-0" /></a>
                ...
                <div className="collapse navbar-collapse pl-10" id="navbarSupportedContent">
                    ...
                    {user.loggedIn ? (
                        <li className="nav-item dropdown navbar-height">
                            ...
                            <ul className="dropdown-menu p-0 bg-secondary bg-opacity-80 py-0">
