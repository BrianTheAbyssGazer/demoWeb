...
var EventCell = function(_React$Component) {
  ...
  _createClass(EventCell2, [{
    ...
    value: function render() {
      ...
      }, Event2 ? import_react.default.createElement(Event2, {
        event,
      ...
      return import_react.default.createElement(EventWrapper, Object.assign({}, this.props, {
        type: "date"
      }), import_react.default.createElement("div", Object.assign({}, props, {
        tabIndex: 0,
...
function Pop(_ref2) {
  ...
  return import_react.default.createElement("div", {
    ...
    return import_react.default.createElement(EventCell, {
      key: idx,
      type: "popup",
      localizer,
      event,
...
var Popup = import_react.default.forwardRef(function(props, ref) {
  return import_react.default.createElement(Pop, Object.assign({}, props, {
    popperRef: ref
  }));
});
Popup.propTypes = {
...
function CalOverlay(_ref) {
  ...
  return import_react.default.createElement(Overlay_default, {
    rootClose: true,
    flip: true,
    show: true,
    placement: "bottom",
    ...
    return import_react.default.createElement(Popup, Object.assign({}, props, {
      containerRef,
      ref: popperRef,
      target: overlay.target,
      offset: offset2,
...
var PopOverlay = import_react.default.forwardRef(function(props, ref) {
  return import_react.default.createElement(CalOverlay, Object.assign({}, props, {
    containerRef: ref
  }));
});
...
var EventEndingRow = function(_React$Component) {
  ...
  _createClass(EventEndingRow2, [{
    ...
    value: function renderShowMore(segments, slot) {
      ...
      return count ? import_react.default.createElement("button", {
        type: "button",
        key: "sm_" + slot,
...
var DateContentRow = function(_React$Component) {
  ...
  function DateContentRow2() {
    ...
    _this.renderDummy = function() {
      ...
      }, renderHeader && import_react.default.createElement("div", {
        className: "rbc-row",
        ref: _this.headingRowRef
      }, range3.map(_this.renderHeadingCell)), import_react.default.createElement("div", {
        className: "rbc-row",
    ...
    _this.containerRef = (0, import_react.createRef)();
    _this.headingRowRef = (0, import_react.createRef)();
    _this.eventRowRef = (0, import_react.createRef)();
  ...
  _createClass(DateContentRow2, [{
    ...
    value: function render() {
      ...
      return import_react.default.createElement("div", {
        ...
        role: "rowgroup",
        ref: this.containerRef
      }, import_react.default.createElement(BackgroundCells, {
        localizer,
        date: date2,
        getNow: getNow2,
        rtl,
      ...
      }, range3.map(this.renderHeadingCell)), import_react.default.createElement(ScrollableWeekComponent, null, import_react.default.createElement(WeekWrapper, Object.assign({
        isAllDay
      }, eventRowProps, {
        rtl: this.props.rtl
      }), levels.map(function(segs, idx) {
        return import_react.default.createElement(EventRow, Object.assign({
          key: idx,
          segments: segs
        }, eventRowProps));
      }), !!extra.length && import_react.default.createElement(EventEndingRow, Object.assign({
        segments: extra,
...
var DateHeader = function DateHeader2(_ref) {
  ...
  if (!drilldownView) {
    return import_react.default.createElement("span", null, label);
  }
...
var MonthView = function(_React$Component) {
  ...
  function MonthView2() {
    ...
    _this.renderWeek = function(week, weekIdx) {
      ...
      return import_react.default.createElement(DateContentRow, {
        key: weekIdx,
    ...
    _this.readerDateHeading = function(_ref) {
      ...
      return import_react.default.createElement("div", Object.assign({}, props, {
        ...
        role: "cell"
      }), import_react.default.createElement(DateHeaderComponent, {
        label,
        date: date2,
        drilldownView,
        isOffRange,
    ...
    _this.containerRef = (0, import_react.createRef)();
    _this.slotRowRef = (0, import_react.createRef)();
    _this._bgRows = [];
  ...
  _createClass(MonthView2, [{
    ...
    value: function renderHeaders(row) {
      ...
      return localizer.range(first, last2, "day").map(function(day2, idx) {
        ...
        }, import_react.default.createElement(HeaderComponent, {
          date: day2,
          localizer,
    ...
    value: function renderOverlay() {
      ...
      return import_react.default.createElement(PopOverlay, {
        overlay,
        accessors,
        localizer,
        components: components2,
    ...
    value: function render() {
      ...
      return import_react.default.createElement("div", Object.assign({
        ...
        return import_react.default.createElement(Wrapper, {
          ...
          value,
          resource
        }, import_react.default.createElement("div", Object.assign({}, slotProps, {
...
function TimeGridEvent(props) {
  ...
  var inner = [import_react.default.createElement("div", {
    key: "1",
    className: "rbc-event-label"
  }, label), import_react.default.createElement("div", {
    key: "2",
    className: "rbc-event-content"
  }, Event2 ? import_react.default.createElement(Event2, {
    event,
  ...
  return import_react.default.createElement(EventWrapper, Object.assign({
    type: "time"
  }, props), import_react.default.createElement("div", {
    onClick,
    onDoubleClick,
    style: eventStyle,
    onKeyPress,
...
var DayColumnWrapper$1 = import_react.default.forwardRef(function(props, ref) {
  return import_react.default.createElement(DayColumnWrapper, Object.assign({}, props, {
    innerRef: ref
  }));
});
...
var DayColumn = function(_React$Component) {
  ...
  function DayColumn2() {
    ...
    _this.renderEvents = function(_ref) {
      ...
      return styledEvents.map(function(_ref2, idx) {
        ...
        return import_react.default.createElement(TimeGridEvent, {
          style,
          event,
          label,
          key: "evt_" + idx,
  ...
  _createClass(DayColumn2, [{
    ...
    value: function render() {
      ...
      return import_react.default.createElement(DayColumnWrapperComponent, {
        ref: this.containerRef,
        date: date2,
        style,
        ...
        return import_react.default.createElement(TimeSlotGroup, {
          key: idx,
          group: grp,
          resource,
          getters,
      ...
      }), import_react.default.createElement(EventContainer, {
        localizer,
        resource,
        accessors,
        getters,
      ...
      }))), selecting && import_react.default.createElement("div", {
        className: "rbc-slot-selection",
        style: {
          top,
          height: height2
        }
      }, import_react.default.createElement("span", null, localizer.format(selectDates, "selectRangeFormat"))), isNow && this.intervalTriggered && import_react.default.createElement("div", {
...
var TimeGutter = function TimeGutter2(_ref2) {
  ...
  var _useMemo = (0, import_react.useMemo)(
    function() {
      return adjustForDST({
        min: min2,
        max: max2,
  ...
  var _useState = (0, import_react.useState)(getSlotMetrics({
    min: start,
    max: end,
    timeslots,
    step,
  ...
  return import_react.default.createElement(TimeGutterWrapper, {
    slotMetrics
  }, import_react.default.createElement("div", {
...
var TimeGutter$1 = import_react.default.forwardRef(function(props, ref) {
  return import_react.default.createElement(TimeGutter, Object.assign({
    gutterRef: ref
  }, props));
});
var ResourceHeader = function ResourceHeader2(_ref) {
  var label = _ref.label;
  return import_react.default.createElement(import_react.default.Fragment, null, label);
};
  ...
  _createClass(TimeGridHeader2, [{
    ...
    value: function renderHeaderCells(range3) {
      ...
      return range3.map(function(date2, i) {
        ...
        var header = import_react.default.createElement(HeaderComponent, {
          date: date2,
          label,
          localizer
        });
        ...
        }, drilldownView ? import_react.default.createElement("button", {
          type: "button",
          className: "rbc-button-link",
          onClick: function onClick(e) {
            return _this2.handleHeaderClick(date2, drilldownView, e);
          }
        }, header) : import_react.default.createElement("span", null, header));
      });
    }
  }, {
    key: "render",
    value: function render() {
      ...
      }, TimeGutterHeader && import_react.default.createElement(TimeGutterHeader, null)), resources.map(function(_ref, idx) {
        var _ref2 = _slicedToArray(_ref, 2), id = _ref2[0], resource = _ref2[1];
        return import_react.default.createElement("div", {
          className: "rbc-time-header-content",
          key: id || idx
        }, resource && import_react.default.createElement("div", {
          className: "rbc-row rbc-row-resource",
          key: "resource_".concat(idx)
        }, import_react.default.createElement("div", {
          className: "rbc-header"
        }, import_react.default.createElement(ResourceHeaderComponent, {
          index: idx,
          label: accessors.resourceTitle(resource),
          resource
        }))), import_react.default.createElement("div", {
          className: "rbc-row rbc-time-header-cell".concat(range3.length <= 1 ? " rbc-time-header-cell-single-day" : "")
        }, _this3.renderHeaderCells(range3)), import_react.default.createElement(DateContentRow, {
          isAllDay: true,
          rtl,
          getNow: getNow2,
          minRows: 2,
  ...
  _createClass(TimeGrid2, [{
    ...
    value: function renderEvents(range3, events, backgroundEvents, now) {
      ...
      return resources.map(function(_ref, i) {
        ...
        return range3.map(function(date2, jj) {
          ...
          return import_react.default.createElement(DayColumn, Object.assign({}, _this2.props, {
            localizer,
    ...
    value: function render() {
      ...
      return import_react.default.createElement("div", {
        ...
        ref: this.containerRef
      }, import_react.default.createElement(TimeGridHeader, {
        range: range3,
        events: allDayEvents,
        width,
        rtl,
        ...
        resizable
      }), this.props.popup && this.renderOverlay(), import_react.default.createElement("div", {
        ref: this.contentRef,
        className: "rbc-time-content",
        onScroll: this.handleScroll
      }, import_react.default.createElement(TimeGutter$1, {
        date: start,
        ref: this.gutterRef,
        localizer,
...
var Day = function(_React$Component) {
  ...
  _createClass(Day2, [{
    ...
    value: function render() {
      ...
      return import_react.default.createElement(TimeGrid, Object.assign({}, props, {
        range: range3,
        eventOffset: 10,
        localizer,
        min: min2,
...
function Agenda(_ref) {
  ...
  var renderDay = function renderDay2(day2, events2, dayKey) {
    ...
    return events2.map(function(event, idx) {
      ...
      var first = idx === 0 ? import_react.default.createElement("td", {
        rowSpan: events2.length,
        className: "rbc-agenda-date-cell"
      }, AgendaDate ? import_react.default.createElement(AgendaDate, {
        day: day2,
        label: dateLabel
      }) : dateLabel) : false;
      ...
      }, first, import_react.default.createElement("td", {
        className: "rbc-agenda-time-cell"
      }, timeRangeLabel(day2, event)), import_react.default.createElement("td", {
  ...
  var timeRangeLabel = function timeRangeLabel2(day2, event) {
    ...
    }, TimeComponent ? import_react.default.createElement(TimeComponent, {
      event,
      day: day2,
      label
    }) : label);
  ...
  }, events.length !== 0 ? import_react.default.createElement(import_react.default.Fragment, null, import_react.default.createElement("table", {
    ref: headerRef,
    className: "rbc-agenda-table"
  }, import_react.default.createElement("thead", null, import_react.default.createElement("tr", null, import_react.default.createElement("th", {
    className: "rbc-header",
    ref: dateColRef
  }, messages2.date), import_react.default.createElement("th", {
    className: "rbc-header",
    ref: timeColRef
  }, messages2.time), import_react.default.createElement("th", {
    className: "rbc-header"
  }, messages2.event)))), import_react.default.createElement("div", {
    className: "rbc-agenda-content",
    ref: contentRef
  }, import_react.default.createElement("table", {
    className: "rbc-agenda-table"
  }, import_react.default.createElement("tbody", {
    ref: tbodyRef
...
var Toolbar = function(_React$Component) {
  ...
  _createClass(Toolbar2, [{
    ...
    value: function render() {
      ...
      }, messages2.today), import_react.default.createElement("button", {
        type: "button",
        onClick: this.navigate.bind(null, navigate.PREVIOUS)
      }, messages2.previous), import_react.default.createElement("button", {
        type: "button",
        onClick: this.navigate.bind(null, navigate.NEXT)
      }, messages2.next)), import_react.default.createElement("span", {
...
var Calendar = function(_React$Component) {
  ...
  _createClass(Calendar2, [{
    ...
    value: function render() {
      ...
      return import_react.default.createElement("div", Object.assign({}, elementProps, {
        className: clsx_m_default(className, "rbc-calendar", props.rtl && "rbc-rtl"),
        style
      }), toolbar && import_react.default.createElement(CalToolbar, {
        date: current,
        view,
        views: viewNames2,
        label,
        ...
        localizer
      }), import_react.default.createElement(View, Object.assign({}, props, {
        events,
        backgroundEvents,
        date: current,
        getNow: getNow2,
